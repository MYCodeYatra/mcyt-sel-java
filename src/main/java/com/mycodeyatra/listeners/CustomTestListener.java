...
/**
 * CustomTestListener implements ITestListener to intercept
 * every phase of the TestNG lifecycle and log it clearly.
 * Register via @Listeners annotation or testng.xml <listeners> block.
 */
